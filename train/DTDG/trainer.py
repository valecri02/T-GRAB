...
class DTDGTrainer(Trainer):
    def __init__(self):
        super(DTDGTrainer, self).__init__()
        # Set model
    ...
    def _get_model_card(self) -> str:
        ...
        trainer_get_model_id = super(DTDGTrainer, self)._get_model_card()
    ...
    def _get_run_save_dir(self) -> str:
        trainer_run_save_dir = super(DTDGTrainer, self)._get_run_save_dir()
